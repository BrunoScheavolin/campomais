...
ActiveRecord::Schema[7.2].define(version: 2025_05_06_012002) do
  ...
  create_table "module_properties", force: :cascade do |t|
    t.bigint "production_modules_id", null: false
    t.bigint "property_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["production_modules_id"], name: "index_module_properties_on_production_modules_id"
  ...
  add_foreign_key "module_properties", "production_modules", column: "production_modules_id"
